...
struct StatusEntry
{
    ...
    static StatusEntry
    makeGlobalTearingStatus()
    {
        return {.eType = TYPE::GLOBAL_TEARING_STATUS };
    }
#endif
...
inline StatusEntry g_aStatusEntries[] {
    ...
    // StatusEntry::makeFileWatch("/sys/class/drm/card2/device/hwmon/hwmon3/power1_average", 3000.0, formatGpuPower), /* 6750xt */
    StatusEntry::makeDateTime("%Y-%m-%d %I:%M%p", 1000.0*10), /* `man strftime` */
#ifdef OPT_IPC_KBLAYOUT
    StatusEntry::makeGlobalTearingStatus(),
